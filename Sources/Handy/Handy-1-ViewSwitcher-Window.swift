...
///
/// The `ViewSwitcherProtocol` protocol exposes the methods and properties of an underlying `HdyViewSwitcher` instance.
...
///
public protocol ViewSwitcherProtocol: Gtk.BinProtocol, Gtk.BuildableProtocol {
        /// Untyped pointer to the underlying `HdyViewSwitcher` instance.
    var ptr: UnsafeMutableRawPointer! { get }

    /// Typed pointer to the underlying `HdyViewSwitcher` instance.
    var view_switcher_ptr: UnsafeMutablePointer<HdyViewSwitcher>! { get }
...
///
/// The `ViewSwitcherRef` type acts as a lightweight Swift reference to an underlying `HdyViewSwitcher` instance.
/// It exposes methods that can operate on this data type through `ViewSwitcherProtocol` conformance.
/// Use `ViewSwitcherRef` only as an `unowned` reference to an existing `HdyViewSwitcher` instance.
///
...
public extension ViewSwitcherRef {
    ...
    @inlinable init(_ p: UnsafeMutablePointer<HdyViewSwitcher>) {
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Designated initialiser from a constant pointer to the underlying `C` data type
    @inlinable init(_ p: UnsafePointer<HdyViewSwitcher>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: p))
    }

    /// Conditional initialiser from an optional pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafeMutablePointer<HdyViewSwitcher>?) {
        guard let p = maybePointer else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Conditional initialiser from an optional, non-mutable pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafePointer<HdyViewSwitcher>?) {
...
///
/// The `ViewSwitcher` type acts as a reference-counted owner of an underlying `HdyViewSwitcher` instance.
...
open class ViewSwitcher: Gtk.Bin, ViewSwitcherProtocol {
    ...
    @inlinable public init(_ op: UnsafeMutablePointer<HdyViewSwitcher>) {
    ...
    /// i.e., ownership is transferred to the `ViewSwitcher` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<HdyViewSwitcher>) {
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// Will retain `HdyViewSwitcher`.
    /// i.e., ownership is transferred to the `ViewSwitcher` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<HdyViewSwitcher>) {
...
public enum ViewSwitcherPropertyName: String, PropertyNameProtocol {
    ...
    /// the ellipsis.
    case narrowEllipsize = "narrow-ellipsize"
...
public enum ViewSwitcherSignalName: String, SignalNameProtocol {
    ...
    /// has the side-effect that the label requests only enough space to display
    /// the ellipsis.
    case notifyNarrowEllipsize = "notify::narrow-ellipsize"
...
public extension ViewSwitcherProtocol {
    /// Return the stored, untyped pointer as a typed pointer to the `HdyViewSwitcher` instance.
    @inlinable var view_switcher_ptr: UnsafeMutablePointer<HdyViewSwitcher>! { return ptr?.assumingMemoryBound(to: HdyViewSwitcher.self) }

    /// Get the ellipsizing position of the narrow mode label. See
    /// `hdy_view_switcher_set_narrow_ellipsize()`.
    @inlinable func getNarrowEllipsize() -> PangoEllipsizeMode {
        let rv = hdy_view_switcher_get_narrow_ellipsize(view_switcher_ptr)
        return rv
    }

    /// Gets the policy of `self`.
    @inlinable func getPolicy() -> HdyViewSwitcherPolicy {
        let rv = hdy_view_switcher_get_policy(view_switcher_ptr)
        return rv
    }
    ...
    @inlinable func getStack() -> Gtk.StackRef! {
        let rv = Gtk.StackRef(hdy_view_switcher_get_stack(view_switcher_ptr))
        return rv
    }

    /// Set the mode used to ellipsize the text in narrow mode if there is not
    /// enough space to render the entire string.
    @inlinable func setNarrowEllipsize(mode: PangoEllipsizeMode) {
        hdy_view_switcher_set_narrow_ellipsize(view_switcher_ptr, mode)
    
    }

    /// Sets the policy of `self`.
    @inlinable func set(policy: HdyViewSwitcherPolicy) {
        hdy_view_switcher_set_policy(view_switcher_ptr, policy)
    
    }

    /// Sets the `GtkStack` to control.
    @inlinable func set(stack: Gtk.StackRef? = nil) {
        hdy_view_switcher_set_stack(view_switcher_ptr, stack?.stack_ptr)
    
    }
    /// Sets the `GtkStack` to control.
    @inlinable func set<StackT: Gtk.StackProtocol>(stack: StackT?) {
        hdy_view_switcher_set_stack(view_switcher_ptr, stack?.stack_ptr)
    
    }
    /// Get the ellipsizing position of the narrow mode label. See
    /// `hdy_view_switcher_set_narrow_ellipsize()`.
    @inlinable var narrowEllipsize: PangoEllipsizeMode {
        /// Get the ellipsizing position of the narrow mode label. See
        /// `hdy_view_switcher_set_narrow_ellipsize()`.
        get {
            let rv = hdy_view_switcher_get_narrow_ellipsize(view_switcher_ptr)
        ...
        /// enough space to render the entire string.
        nonmutating set {
            hdy_view_switcher_set_narrow_ellipsize(view_switcher_ptr, newValue)
        }
    }

    /// The `HdyViewSwitcherPolicy` the view switcher should use to determine which
    /// mode to use.
    @inlinable var policy: HdyViewSwitcherPolicy {
        /// Gets the policy of `self`.
        get {
            let rv = hdy_view_switcher_get_policy(view_switcher_ptr)
            return rv
        ...
        /// Sets the policy of `self`.
        nonmutating set {
            hdy_view_switcher_set_policy(view_switcher_ptr, newValue)
        }
    }

    /// The `GtkStack` the view switcher controls.
    @inlinable var stack: Gtk.StackRef! {
        /// Get the `GtkStack` being controlled by the `HdyViewSwitcher`.
        /// 
        /// See: `hdy_view_switcher_set_stack()`
        get {
        ...
        /// Sets the `GtkStack` to control.
        nonmutating set {
            hdy_view_switcher_set_stack(view_switcher_ptr, UnsafeMutablePointer<GtkStack>(newValue?.stack_ptr))
        }
    }
...
///
/// The `ViewSwitcherBarProtocol` protocol exposes the methods and properties of an underlying `HdyViewSwitcherBar` instance.
/// The default implementation of these can be found in the protocol extension below.
...
///
public protocol ViewSwitcherBarProtocol: Gtk.BinProtocol, Gtk.BuildableProtocol {
        /// Untyped pointer to the underlying `HdyViewSwitcherBar` instance.
    var ptr: UnsafeMutableRawPointer! { get }

    /// Typed pointer to the underlying `HdyViewSwitcherBar` instance.
    var view_switcher_bar_ptr: UnsafeMutablePointer<HdyViewSwitcherBar>! { get }
...
///
/// The `ViewSwitcherBarRef` type acts as a lightweight Swift reference to an underlying `HdyViewSwitcherBar` instance.
/// It exposes methods that can operate on this data type through `ViewSwitcherBarProtocol` conformance.
/// Use `ViewSwitcherBarRef` only as an `unowned` reference to an existing `HdyViewSwitcherBar` instance.
///
...
public extension ViewSwitcherBarRef {
    /// Designated initialiser from the underlying `C` data type
    @inlinable init(_ p: UnsafeMutablePointer<HdyViewSwitcherBar>) {
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Designated initialiser from a constant pointer to the underlying `C` data type
    @inlinable init(_ p: UnsafePointer<HdyViewSwitcherBar>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: p))
    }

    /// Conditional initialiser from an optional pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafeMutablePointer<HdyViewSwitcherBar>?) {
        guard let p = maybePointer else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Conditional initialiser from an optional, non-mutable pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafePointer<HdyViewSwitcherBar>?) {
        guard let p = UnsafeMutablePointer(mutating: maybePointer) else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }
...
///
/// The `ViewSwitcherBar` type acts as a reference-counted owner of an underlying `HdyViewSwitcherBar` instance.
...
open class ViewSwitcherBar: Gtk.Bin, ViewSwitcherBarProtocol {
    ...
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<HdyViewSwitcherBar>) {
        super.init(cPointer: op)
    }
    ...
    /// i.e., ownership is transferred to the `ViewSwitcherBar` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<HdyViewSwitcherBar>) {
        super.init(raw: UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: op)))
    }
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// Will retain `HdyViewSwitcherBar`.
    /// i.e., ownership is transferred to the `ViewSwitcherBar` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<HdyViewSwitcherBar>) {
        super.init(retainingCPointer: op)
    }
...
public extension ViewSwitcherBarProtocol {
    /// Return the stored, untyped pointer as a typed pointer to the `HdyViewSwitcherBar` instance.
    @inlinable var view_switcher_bar_ptr: UnsafeMutablePointer<HdyViewSwitcherBar>! { return ptr?.assumingMemoryBound(to: HdyViewSwitcherBar.self) }

    /// Gets the policy of `self`.
    @inlinable func getPolicy() -> HdyViewSwitcherPolicy {
        let rv = hdy_view_switcher_bar_get_policy(view_switcher_bar_ptr)
        return rv
    }

    /// Gets whether `self` should be revealed or not.
    @inlinable func getReveal() -> Bool {
        let rv = ((hdy_view_switcher_bar_get_reveal(view_switcher_bar_ptr)) != 0)
        return rv
    }

    /// Get the `GtkStack` being controlled by the `HdyViewSwitcher`.
    @inlinable func getStack() -> Gtk.StackRef! {
        let rv = Gtk.StackRef(hdy_view_switcher_bar_get_stack(view_switcher_bar_ptr))
        return rv
    }

    /// Sets the policy of `self`.
    @inlinable func set(policy: HdyViewSwitcherPolicy) {
        hdy_view_switcher_bar_set_policy(view_switcher_bar_ptr, policy)
    
    }

    /// Sets whether `self` should be revealed or not.
    @inlinable func set(reveal: Bool) {
        hdy_view_switcher_bar_set_reveal(view_switcher_bar_ptr, gboolean((reveal) ? 1 : 0))
    
    }

    /// Sets the `GtkStack` to control.
    @inlinable func set(stack: Gtk.StackRef? = nil) {
        hdy_view_switcher_bar_set_stack(view_switcher_bar_ptr, stack?.stack_ptr)
    ...
    @inlinable var policy: HdyViewSwitcherPolicy {
        ...
        /// Sets the policy of `self`.
        nonmutating set {
            hdy_view_switcher_bar_set_policy(view_switcher_bar_ptr, newValue)
        }
    }
    ...
    @inlinable var reveal: Bool {
        ...
        /// Sets whether `self` should be revealed or not.
        nonmutating set {
            hdy_view_switcher_bar_set_reveal(view_switcher_bar_ptr, gboolean((newValue) ? 1 : 0))
        }
    }
    ...
    @inlinable var stack: Gtk.StackRef! {
        ...
        /// Sets the `GtkStack` to control.
        nonmutating set {
            hdy_view_switcher_bar_set_stack(view_switcher_bar_ptr, UnsafeMutablePointer<GtkStack>(newValue?.stack_ptr))
        }
    }
...
///
/// The `ViewSwitcherTitleProtocol` protocol exposes the methods and properties of an underlying `HdyViewSwitcherTitle` instance.
/// The default implementation of these can be found in the protocol extension below.
...
///
public protocol ViewSwitcherTitleProtocol: Gtk.BinProtocol, Gtk.BuildableProtocol {
        /// Untyped pointer to the underlying `HdyViewSwitcherTitle` instance.
    var ptr: UnsafeMutableRawPointer! { get }

    /// Typed pointer to the underlying `HdyViewSwitcherTitle` instance.
    var view_switcher_title_ptr: UnsafeMutablePointer<HdyViewSwitcherTitle>! { get }
...
///
/// The `ViewSwitcherTitleRef` type acts as a lightweight Swift reference to an underlying `HdyViewSwitcherTitle` instance.
/// It exposes methods that can operate on this data type through `ViewSwitcherTitleProtocol` conformance.
/// Use `ViewSwitcherTitleRef` only as an `unowned` reference to an existing `HdyViewSwitcherTitle` instance.
///
...
public extension ViewSwitcherTitleRef {
    /// Designated initialiser from the underlying `C` data type
    @inlinable init(_ p: UnsafeMutablePointer<HdyViewSwitcherTitle>) {
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Designated initialiser from a constant pointer to the underlying `C` data type
    @inlinable init(_ p: UnsafePointer<HdyViewSwitcherTitle>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: p))
    }

    /// Conditional initialiser from an optional pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafeMutablePointer<HdyViewSwitcherTitle>?) {
        guard let p = maybePointer else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Conditional initialiser from an optional, non-mutable pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafePointer<HdyViewSwitcherTitle>?) {
        guard let p = UnsafeMutablePointer(mutating: maybePointer) else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }
    ...
    @inlinable init() {
        let rv = hdy_view_switcher_title_new()
...
///
/// The `ViewSwitcherTitle` type acts as a reference-counted owner of an underlying `HdyViewSwitcherTitle` instance.
/// It provides the methods that can operate on this data type through `ViewSwitcherTitleProtocol` conformance.
/// Use `ViewSwitcherTitle` as a strong reference or owner of a `HdyViewSwitcherTitle` instance.
///
open class ViewSwitcherTitle: Gtk.Bin, ViewSwitcherTitleProtocol {
        /// Designated initialiser from the underlying `C` data type.
    /// This creates an instance without performing an unbalanced retain
    /// i.e., ownership is transferred to the `ViewSwitcherTitle` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<HdyViewSwitcherTitle>) {
        super.init(cPointer: op)
    }
    ...
    /// i.e., ownership is transferred to the `ViewSwitcherTitle` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<HdyViewSwitcherTitle>) {
        super.init(raw: UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: op)))
    }
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// Will retain `HdyViewSwitcherTitle`.
    /// i.e., ownership is transferred to the `ViewSwitcherTitle` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<HdyViewSwitcherTitle>) {
        super.init(retainingCPointer: op)
    }
...
public extension ViewSwitcherTitleProtocol {
    /// Return the stored, untyped pointer as a typed pointer to the `HdyViewSwitcherTitle` instance.
    @inlinable var view_switcher_title_ptr: UnsafeMutablePointer<HdyViewSwitcherTitle>! { return ptr?.assumingMemoryBound(to: HdyViewSwitcherTitle.self) }

    /// Gets the policy of `self`.
    @inlinable func getPolicy() -> HdyViewSwitcherPolicy {
        let rv = hdy_view_switcher_title_get_policy(view_switcher_title_ptr)
        return rv
    }

    /// Get the `GtkStack` being controlled by the `HdyViewSwitcher`.
    @inlinable func getStack() -> Gtk.StackRef! {
        let rv = Gtk.StackRef(hdy_view_switcher_title_get_stack(view_switcher_title_ptr))
        return rv
    }

    /// Gets the subtitle of `self`. See `hdy_view_switcher_title_set_subtitle()`.
    @inlinable func getSubtitle() -> String! {
        let rv = hdy_view_switcher_title_get_subtitle(view_switcher_title_ptr).map({ String(cString: $0) })
        return rv
    }

    /// Gets the title of `self`. See `hdy_view_switcher_title_set_title()`.
    @inlinable func getTitle() -> String! {
        let rv = hdy_view_switcher_title_get_title(view_switcher_title_ptr).map({ String(cString: $0) })
        return rv
    }

    /// Get whether the title label of `self` is visible.
    @inlinable func getTitleVisible() -> Bool {
        let rv = ((hdy_view_switcher_title_get_title_visible(view_switcher_title_ptr)) != 0)
        return rv
    }
    ...
    @inlinable func getViewSwitcherEnabled() -> Bool {
        let rv = ((hdy_view_switcher_title_get_view_switcher_enabled(view_switcher_title_ptr)) != 0)
        return rv
    }

    /// Sets the policy of `self`.
    @inlinable func set(policy: HdyViewSwitcherPolicy) {
        hdy_view_switcher_title_set_policy(view_switcher_title_ptr, policy)
    
    }

    /// Sets the `GtkStack` to control.
    @inlinable func set(stack: Gtk.StackRef? = nil) {
        hdy_view_switcher_title_set_stack(view_switcher_title_ptr, stack?.stack_ptr)
    ...
    @inlinable func set(subtitle: UnsafePointer<gchar>? = nil) {
        hdy_view_switcher_title_set_subtitle(view_switcher_title_ptr, subtitle)
    ...
    @inlinable func set(title: UnsafePointer<gchar>? = nil) {
        hdy_view_switcher_title_set_title(view_switcher_title_ptr, title)
    ...
    @inlinable func setViewSwitcher(enabled: Bool) {
        hdy_view_switcher_title_set_view_switcher_enabled(view_switcher_title_ptr, gboolean((enabled) ? 1 : 0))
    ...
    @inlinable var policy: HdyViewSwitcherPolicy {
        ...
        /// Sets the policy of `self`.
        nonmutating set {
            hdy_view_switcher_title_set_policy(view_switcher_title_ptr, newValue)
        }
    }
    ...
    @inlinable var stack: Gtk.StackRef! {
        ...
        /// Sets the `GtkStack` to control.
        nonmutating set {
            hdy_view_switcher_title_set_stack(view_switcher_title_ptr, UnsafeMutablePointer<GtkStack>(newValue?.stack_ptr))
        }
    }
    ...
    @inlinable var subtitle: String! {
        ...
        /// details.
        nonmutating set {
            hdy_view_switcher_title_set_subtitle(view_switcher_title_ptr, newValue)
        }
    }
    ...
    @inlinable var title: String! {
        ...
        /// good title should not include the application name.
        nonmutating set {
            hdy_view_switcher_title_set_title(view_switcher_title_ptr, newValue)
        }
    }
    ...
    @inlinable var viewSwitcherEnabled: Bool {
        ...
        /// window width, or any other constraint you find suitable.
        nonmutating set {
            hdy_view_switcher_title_set_view_switcher_enabled(view_switcher_title_ptr, gboolean((newValue) ? 1 : 0))
        }
    }
...
///
/// The `WindowProtocol` protocol exposes the methods and properties of an underlying `HdyWindow` instance.
/// The default implementation of these can be found in the protocol extension below.
...
///
public protocol WindowProtocol: Gtk.WindowProtocol, Gtk.BuildableProtocol {
        /// Untyped pointer to the underlying `HdyWindow` instance.
    var ptr: UnsafeMutableRawPointer! { get }

    /// Typed pointer to the underlying `HdyWindow` instance.
    var window_ptr: UnsafeMutablePointer<HdyWindow>! { get }
...
///
/// The `WindowRef` type acts as a lightweight Swift reference to an underlying `HdyWindow` instance.
/// It exposes methods that can operate on this data type through `WindowProtocol` conformance.
/// Use `WindowRef` only as an `unowned` reference to an existing `HdyWindow` instance.
///
...
public extension WindowRef {
    /// Designated initialiser from the underlying `C` data type
    @inlinable init(_ p: UnsafeMutablePointer<HdyWindow>) {
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Designated initialiser from a constant pointer to the underlying `C` data type
    @inlinable init(_ p: UnsafePointer<HdyWindow>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: p))
    }

    /// Conditional initialiser from an optional pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafeMutablePointer<HdyWindow>?) {
        guard let p = maybePointer else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Conditional initialiser from an optional, non-mutable pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafePointer<HdyWindow>?) {
        guard let p = UnsafeMutablePointer(mutating: maybePointer) else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }
...
///
/// The `Window` type acts as a reference-counted owner of an underlying `HdyWindow` instance.
...
open class Window: Gtk.Window, WindowProtocol {
    ...
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<HdyWindow>) {
        super.init(cPointer: op)
    }
    ...
    /// i.e., ownership is transferred to the `Window` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<HdyWindow>) {
        super.init(raw: UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: op)))
    }
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// Will retain `HdyWindow`.
    /// i.e., ownership is transferred to the `Window` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<HdyWindow>) {
        super.init(retainingCPointer: op)
    }
    ...
    @inlinable public init<T: WindowProtocol>(handyWindow other: T) {
        super.init(retainingRaw: other.ptr)
    }
...
// MARK: Window has no signals
// MARK: Window Class: WindowProtocol extension (methods and fields)
public extension WindowProtocol {
    /// Return the stored, untyped pointer as a typed pointer to the `HdyWindow` instance.
    @inlinable var window_ptr: UnsafeMutablePointer<HdyWindow>! { return ptr?.assumingMemoryBound(to: HdyWindow.self) }
