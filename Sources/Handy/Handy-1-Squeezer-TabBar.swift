...
///
/// The `SqueezerProtocol` protocol exposes the methods and properties of an underlying `HdySqueezer` instance.
...
///
public protocol SqueezerProtocol: Gtk.ContainerProtocol, Gtk.BuildableProtocol, Gtk.OrientableProtocol {
        /// Untyped pointer to the underlying `HdySqueezer` instance.
    var ptr: UnsafeMutableRawPointer! { get }

    /// Typed pointer to the underlying `HdySqueezer` instance.
    var squeezer_ptr: UnsafeMutablePointer<HdySqueezer>! { get }
...
///
/// The `SqueezerRef` type acts as a lightweight Swift reference to an underlying `HdySqueezer` instance.
/// It exposes methods that can operate on this data type through `SqueezerProtocol` conformance.
/// Use `SqueezerRef` only as an `unowned` reference to an existing `HdySqueezer` instance.
///
...
public extension SqueezerRef {
    ...
    @inlinable init(_ p: UnsafeMutablePointer<HdySqueezer>) {
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Designated initialiser from a constant pointer to the underlying `C` data type
    @inlinable init(_ p: UnsafePointer<HdySqueezer>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: p))
    }

    /// Conditional initialiser from an optional pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafeMutablePointer<HdySqueezer>?) {
        guard let p = maybePointer else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Conditional initialiser from an optional, non-mutable pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafePointer<HdySqueezer>?) {
...
///
/// The `Squeezer` type acts as a reference-counted owner of an underlying `HdySqueezer` instance.
...
open class Squeezer: Gtk.Container, SqueezerProtocol {
    ...
    @inlinable public init(_ op: UnsafeMutablePointer<HdySqueezer>) {
    ...
    /// i.e., ownership is transferred to the `Squeezer` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<HdySqueezer>) {
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// Will retain `HdySqueezer`.
    /// i.e., ownership is transferred to the `Squeezer` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<HdySqueezer>) {
...
public extension SqueezerProtocol {
    /// Return the stored, untyped pointer as a typed pointer to the `HdySqueezer` instance.
    @inlinable var squeezer_ptr: UnsafeMutablePointer<HdySqueezer>! { return ptr?.assumingMemoryBound(to: HdySqueezer.self) }

    /// Gets whether `child` is enabled.
    /// 
    /// See `hdy_squeezer_set_child_enabled()`.
    @inlinable func getChildEnabled<WidgetT: Gtk.WidgetProtocol>(child: WidgetT) -> Bool {
        let rv = ((hdy_squeezer_get_child_enabled(squeezer_ptr, child.widget_ptr)) != 0)
        return rv
    }
    ...
    @inlinable func getHomogeneous() -> Bool {
        let rv = ((hdy_squeezer_get_homogeneous(squeezer_ptr)) != 0)
        return rv
    }
    ...
    @inlinable func getInterpolateSize() -> Bool {
        let rv = ((hdy_squeezer_get_interpolate_size(squeezer_ptr)) != 0)
        return rv
    }
    ...
    @inlinable func getTransitionDuration() -> Int {
        let rv = Int(hdy_squeezer_get_transition_duration(squeezer_ptr))
        return rv
    }

    /// Gets whether `self` is currently in a transition from one child to another.
    @inlinable func getTransitionRunning() -> Bool {
        let rv = ((hdy_squeezer_get_transition_running(squeezer_ptr)) != 0)
        return rv
    }

    /// Gets the type of animation that will be used for transitions between children
    /// in `self`.
    @inlinable func getTransitionType() -> HdySqueezerTransitionType {
        let rv = hdy_squeezer_get_transition_type(squeezer_ptr)
        return rv
    }

    /// Gets the currently visible child of `self`, or `nil` if there are no visible
    /// children.
    @inlinable func getVisibleChild() -> Gtk.WidgetRef! {
        let rv = Gtk.WidgetRef(hdy_squeezer_get_visible_child(squeezer_ptr))
        return rv
    }

    /// Gets the `HdySqueezer:xalign` property for `self`.
    @inlinable func getXalign() -> Double {
        let rv = Double(hdy_squeezer_get_xalign(squeezer_ptr))
        return rv
    }

    /// Gets the `HdySqueezer:yalign` property for `self`.
    @inlinable func getYalign() -> Double {
        let rv = Double(hdy_squeezer_get_yalign(squeezer_ptr))
        return rv
    }
    ...
    @inlinable func setChildEnabled<WidgetT: Gtk.WidgetProtocol>(child: WidgetT, enabled: Bool) {
        hdy_squeezer_set_child_enabled(squeezer_ptr, child.widget_ptr, gboolean((enabled) ? 1 : 0))
    ...
    @inlinable func set(homogeneous: Bool) {
        hdy_squeezer_set_homogeneous(squeezer_ptr, gboolean((homogeneous) ? 1 : 0))
    ...
    @inlinable func set(interpolateSize: Bool) {
        hdy_squeezer_set_interpolate_size(squeezer_ptr, gboolean((interpolateSize) ? 1 : 0))
    
    }

    /// Sets the duration that transitions between children in `self` will take.
    @inlinable func setTransition(duration: Int) {
        hdy_squeezer_set_transition_duration(squeezer_ptr, guint(duration))
    ...
    /// current.
    @inlinable func setTransitionType(transition: HdySqueezerTransitionType) {
        hdy_squeezer_set_transition_type(squeezer_ptr, transition)
    
    }

    /// Sets the `HdySqueezer:xalign` property for `self`.
    @inlinable func set(xalign: Double) {
        hdy_squeezer_set_xalign(squeezer_ptr, gfloat(xalign))
    
    }

    /// Sets the `HdySqueezer:yalign` property for `self`.
    @inlinable func set(yalign: Double) {
        hdy_squeezer_set_yalign(squeezer_ptr, gfloat(yalign))
    ...
    @inlinable var homogeneous: Bool {
        ...
        /// different child becomes visible.
        nonmutating set {
            hdy_squeezer_set_homogeneous(squeezer_ptr, gboolean((newValue) ? 1 : 0))
        }
    }
    ...
    @inlinable var interpolateSize: Bool {
        ...
        /// e.g. if `self` is horizontal, it will interpolate the its height.
        nonmutating set {
            hdy_squeezer_set_interpolate_size(squeezer_ptr, gboolean((newValue) ? 1 : 0))
        }
    }
    ...
    @inlinable var transitionDuration: Int {
        ...
        /// Sets the duration that transitions between children in `self` will take.
        nonmutating set {
            hdy_squeezer_set_transition_duration(squeezer_ptr, guint(newValue))
        }
    }
    ...
    /// Gets the type of animation that will be used for transitions between children
    /// in `self`.
    @inlinable var transitionType: HdySqueezerTransitionType {
        /// Gets the type of animation that will be used for transitions between children
        /// in `self`.
        get {
            let rv = hdy_squeezer_get_transition_type(squeezer_ptr)
        ...
        /// current.
        nonmutating set {
            hdy_squeezer_set_transition_type(squeezer_ptr, newValue)
        }
    }
    ...
    @inlinable var xalign: Double {
        ...
        /// Sets the `HdySqueezer:xalign` property for `self`.
        nonmutating set {
            hdy_squeezer_set_xalign(squeezer_ptr, gfloat(newValue))
        }
    }
    ...
    @inlinable var yalign: Double {
        ...
        /// Sets the `HdySqueezer:yalign` property for `self`.
        nonmutating set {
            hdy_squeezer_set_yalign(squeezer_ptr, gfloat(newValue))
        }
    }
...
///
/// The `StatusPageProtocol` protocol exposes the methods and properties of an underlying `HdyStatusPage` instance.
/// The default implementation of these can be found in the protocol extension below.
...
///
public protocol StatusPageProtocol: Gtk.BinProtocol, Gtk.BuildableProtocol {
        /// Untyped pointer to the underlying `HdyStatusPage` instance.
    var ptr: UnsafeMutableRawPointer! { get }

    /// Typed pointer to the underlying `HdyStatusPage` instance.
    var status_page_ptr: UnsafeMutablePointer<HdyStatusPage>! { get }
...
///
/// The `StatusPageRef` type acts as a lightweight Swift reference to an underlying `HdyStatusPage` instance.
/// It exposes methods that can operate on this data type through `StatusPageProtocol` conformance.
/// Use `StatusPageRef` only as an `unowned` reference to an existing `HdyStatusPage` instance.
///
...
public extension StatusPageRef {
    /// Designated initialiser from the underlying `C` data type
    @inlinable init(_ p: UnsafeMutablePointer<HdyStatusPage>) {
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Designated initialiser from a constant pointer to the underlying `C` data type
    @inlinable init(_ p: UnsafePointer<HdyStatusPage>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: p))
    }

    /// Conditional initialiser from an optional pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafeMutablePointer<HdyStatusPage>?) {
        guard let p = maybePointer else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Conditional initialiser from an optional, non-mutable pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafePointer<HdyStatusPage>?) {
        guard let p = UnsafeMutablePointer(mutating: maybePointer) else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }
...
///
/// The `StatusPage` type acts as a reference-counted owner of an underlying `HdyStatusPage` instance.
...
open class StatusPage: Gtk.Bin, StatusPageProtocol {
    ...
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<HdyStatusPage>) {
        super.init(cPointer: op)
    }
    ...
    /// i.e., ownership is transferred to the `StatusPage` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<HdyStatusPage>) {
        super.init(raw: UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: op)))
    }
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// Will retain `HdyStatusPage`.
    /// i.e., ownership is transferred to the `StatusPage` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<HdyStatusPage>) {
        super.init(retainingCPointer: op)
    }
...
public extension StatusPageProtocol {
    /// Return the stored, untyped pointer as a typed pointer to the `HdyStatusPage` instance.
    @inlinable var status_page_ptr: UnsafeMutablePointer<HdyStatusPage>! { return ptr?.assumingMemoryBound(to: HdyStatusPage.self) }

    /// Gets the description for `self`.
    @inlinable func getDescription() -> String! {
        let rv = hdy_status_page_get_description(status_page_ptr).map({ String(cString: $0) })
        return rv
    }

    /// Gets the icon name for `self`.
    @inlinable func getIconName() -> String! {
        let rv = hdy_status_page_get_icon_name(status_page_ptr).map({ String(cString: $0) })
        return rv
    }

    /// Gets the title for `self`.
    @inlinable func getTitle() -> String! {
        let rv = hdy_status_page_get_title(status_page_ptr).map({ String(cString: $0) })
        return rv
    }

    /// Sets the description for `self`.
    @inlinable func set(description: UnsafePointer<gchar>? = nil) {
        hdy_status_page_set_description(status_page_ptr, description)
    
    }

    /// Sets the icon name for `self`.
    @inlinable func set(iconName: UnsafePointer<gchar>? = nil) {
        hdy_status_page_set_icon_name(status_page_ptr, iconName)
    
    }

    /// Sets the title for `self`.
    @inlinable func set(title: UnsafePointer<gchar>? = nil) {
        hdy_status_page_set_title(status_page_ptr, title)
    ...
    @inlinable var description: String! {
        ...
        /// Sets the description for `self`.
        nonmutating set {
            hdy_status_page_set_description(status_page_ptr, newValue)
        }
    }
    ...
    @inlinable var iconName: String! {
        ...
        /// Sets the icon name for `self`.
        nonmutating set {
            hdy_status_page_set_icon_name(status_page_ptr, newValue)
        }
    }
    ...
    @inlinable var title: String! {
        ...
        /// Sets the title for `self`.
        nonmutating set {
            hdy_status_page_set_title(status_page_ptr, newValue)
        }
    }
...
// MARK: - SwipeGroup Class


///
/// The `SwipeGroupProtocol` protocol exposes the methods and properties of an underlying `HdySwipeGroup` instance.
/// The default implementation of these can be found in the protocol extension below.
/// For a concrete class that implements these methods and properties, see `SwipeGroup`.
/// Alternatively, use `SwipeGroupRef` as a lighweight, `unowned` reference if you already have an instance you just want to use.
///
public protocol SwipeGroupProtocol: GLibObject.ObjectProtocol, Gtk.BuildableProtocol {
        /// Untyped pointer to the underlying `HdySwipeGroup` instance.
    var ptr: UnsafeMutableRawPointer! { get }

    /// Typed pointer to the underlying `HdySwipeGroup` instance.
    var swipe_group_ptr: UnsafeMutablePointer<HdySwipeGroup>! { get }

    /// Required Initialiser for types conforming to `SwipeGroupProtocol`
    init(raw: UnsafeMutableRawPointer)
}


///
/// The `SwipeGroupRef` type acts as a lightweight Swift reference to an underlying `HdySwipeGroup` instance.
/// It exposes methods that can operate on this data type through `SwipeGroupProtocol` conformance.
/// Use `SwipeGroupRef` only as an `unowned` reference to an existing `HdySwipeGroup` instance.
///
public struct SwipeGroupRef: SwipeGroupProtocol, GWeakCapturing {
        /// Untyped pointer to the underlying `HdySwipeGroup` instance.
    /// For type-safe access, use the generated, typed pointer `swipe_group_ptr` property instead.
    public let ptr: UnsafeMutableRawPointer!
}

public extension SwipeGroupRef {
    /// Designated initialiser from the underlying `C` data type
    @inlinable init(_ p: UnsafeMutablePointer<HdySwipeGroup>) {
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Designated initialiser from a constant pointer to the underlying `C` data type
    @inlinable init(_ p: UnsafePointer<HdySwipeGroup>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: p))
    }

    /// Conditional initialiser from an optional pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafeMutablePointer<HdySwipeGroup>?) {
        guard let p = maybePointer else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Conditional initialiser from an optional, non-mutable pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafePointer<HdySwipeGroup>?) {
        guard let p = UnsafeMutablePointer(mutating: maybePointer) else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }
    ...
    /// Reference intialiser for a related type that implements `SwipeGroupProtocol`
    @inlinable init<T: SwipeGroupProtocol>(_ other: T) {
        ptr = other.ptr
    }

    /// This factory is syntactic sugar for setting weak pointers wrapped in `GWeak<T>`
    @inlinable static func unowned<T: SwipeGroupProtocol>(_ other: T) -> SwipeGroupRef { SwipeGroupRef(other) }

    /// Unsafe typed initialiser.
    /// **Do not use unless you know the underlying data type the pointer points to conforms to `SwipeGroupProtocol`.**
    @inlinable init<T>(cPointer: UnsafeMutablePointer<T>) {
        ptr = UnsafeMutableRawPointer(cPointer)
    }
...
///
/// The `SwipeGroup` type acts as a reference-counted owner of an underlying `HdySwipeGroup` instance.
/// It provides the methods that can operate on this data type through `SwipeGroupProtocol` conformance.
/// Use `SwipeGroup` as a strong reference or owner of a `HdySwipeGroup` instance.
///
open class SwipeGroup: GLibObject.Object, SwipeGroupProtocol {
        /// Designated initialiser from the underlying `C` data type.
    /// This creates an instance without performing an unbalanced retain
    /// i.e., ownership is transferred to the `SwipeGroup` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<HdySwipeGroup>) {
        super.init(cPointer: op)
    }
    ...
    /// i.e., ownership is transferred to the `SwipeGroup` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<HdySwipeGroup>) {
        super.init(raw: UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: op)))
    }
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// Will retain `HdySwipeGroup`.
    /// i.e., ownership is transferred to the `SwipeGroup` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<HdySwipeGroup>) {
        super.init(retainingCPointer: op)
    }

    /// Reference intialiser for a related type that implements `SwipeGroupProtocol`
    /// Will retain `HdySwipeGroup`.
    /// - Parameter other: an instance of a related type that implements `SwipeGroupProtocol`
    @inlinable public init<T: SwipeGroupProtocol>(swipeGroup other: T) {
        super.init(retainingRaw: other.ptr)
    }
...
// MARK: no SwipeGroup properties

public enum SwipeGroupSignalName: String, SignalNameProtocol {
    /// The notify signal is emitted on an object when one of its properties has
    /// its value set through `g_object_set_property()`, `g_object_set()`, et al.
    /// 
    /// Note that getting this signal doesn’t itself guarantee that the value of
...
// MARK: SwipeGroup has no signals
// MARK: SwipeGroup Class: SwipeGroupProtocol extension (methods and fields)
public extension SwipeGroupProtocol {
    /// Return the stored, untyped pointer as a typed pointer to the `HdySwipeGroup` instance.
    @inlinable var swipe_group_ptr: UnsafeMutablePointer<HdySwipeGroup>! { return ptr?.assumingMemoryBound(to: HdySwipeGroup.self) }

    /// When the widget is destroyed or no longer referenced elsewhere, it will
    /// be removed from the swipe group.
    @inlinable func add<SwipeableT: SwipeableProtocol>(swipeable: SwipeableT) {
        hdy_swipe_group_add_swipeable(swipe_group_ptr, swipeable.swipeable_ptr)
    
    }

    /// Returns the list of swipeables associated with `self`.
    @inlinable func getSwipeables() -> GLib.SListRef! {
        let rv = GLib.SListRef(hdy_swipe_group_get_swipeables(swipe_group_ptr))
        return rv
    }

    /// Removes a widget from a `HdySwipeGroup`.
    @inlinable func remove<SwipeableT: SwipeableProtocol>(swipeable: SwipeableT) {
        hdy_swipe_group_remove_swipeable(swipe_group_ptr, swipeable.swipeable_ptr)
    
    }
    /// Returns the list of swipeables associated with `self`.
    @inlinable var swipeables: GLib.SListRef! {
        /// Returns the list of swipeables associated with `self`.
        get {
            let rv = GLib.SListRef(hdy_swipe_group_get_swipeables(swipe_group_ptr))
            return rv
...
///
/// The `SwipeTrackerProtocol` protocol exposes the methods and properties of an underlying `HdySwipeTracker` instance.
/// The default implementation of these can be found in the protocol extension below.
...
public protocol SwipeTrackerProtocol: GLibObject.ObjectProtocol, Gtk.OrientableProtocol {
        /// Untyped pointer to the underlying `HdySwipeTracker` instance.
    var ptr: UnsafeMutableRawPointer! { get }

    /// Typed pointer to the underlying `HdySwipeTracker` instance.
    var swipe_tracker_ptr: UnsafeMutablePointer<HdySwipeTracker>! { get }
...
///
/// The `SwipeTrackerRef` type acts as a lightweight Swift reference to an underlying `HdySwipeTracker` instance.
/// It exposes methods that can operate on this data type through `SwipeTrackerProtocol` conformance.
/// Use `SwipeTrackerRef` only as an `unowned` reference to an existing `HdySwipeTracker` instance.
///
...
public extension SwipeTrackerRef {
    /// Designated initialiser from the underlying `C` data type
    @inlinable init(_ p: UnsafeMutablePointer<HdySwipeTracker>) {
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Designated initialiser from a constant pointer to the underlying `C` data type
    @inlinable init(_ p: UnsafePointer<HdySwipeTracker>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: p))
    }

    /// Conditional initialiser from an optional pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafeMutablePointer<HdySwipeTracker>?) {
        guard let p = maybePointer else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Conditional initialiser from an optional, non-mutable pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafePointer<HdySwipeTracker>?) {
        guard let p = UnsafeMutablePointer(mutating: maybePointer) else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }
    ...
    @inlinable init<SwipeableT: SwipeableProtocol>( swipeable: SwipeableT) {
        let rv = hdy_swipe_tracker_new(swipeable.swipeable_ptr)
        ptr = UnsafeMutableRawPointer(rv)
    }
}
...
///
/// The `SwipeTracker` type acts as a reference-counted owner of an underlying `HdySwipeTracker` instance.
/// It provides the methods that can operate on this data type through `SwipeTrackerProtocol` conformance.
/// Use `SwipeTracker` as a strong reference or owner of a `HdySwipeTracker` instance.
///
open class SwipeTracker: GLibObject.Object, SwipeTrackerProtocol {
    ...
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<HdySwipeTracker>) {
        super.init(cPointer: op)
    }
    ...
    /// i.e., ownership is transferred to the `SwipeTracker` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<HdySwipeTracker>) {
        super.init(raw: UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: op)))
    }
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// Will retain `HdySwipeTracker`.
    /// i.e., ownership is transferred to the `SwipeTracker` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<HdySwipeTracker>) {
        super.init(retainingCPointer: op)
    }
...
public enum SwipeTrackerPropertyName: String, PropertyNameProtocol {
    ...
    /// The widget the swipe tracker is attached to. Must not be `nil`.
...
public extension SwipeTrackerProtocol {
    ...
    /// - Parameter direct: `true` if the swipe is directly triggered by a gesture,   `false` if it's triggered via a `HdySwipeGroup`
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `beginSwipe` signal is emitted
    @discardableResult @inlinable func onBeginSwipe(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: SwipeTrackerRef, _ direction: NavigationDirection, _ direct: Bool) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder3<SwipeTrackerRef, NavigationDirection, Bool, Void>
        let cCallback: @convention(c) (gpointer, UInt32, gboolean, gpointer) -> Void = { unownedSelf, arg1, arg2, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call(SwipeTrackerRef(raw: unownedSelf), NavigationDirection(arg1), ((arg2) != 0))
            return output
        }
        return connect(
            signal: .beginSwipe,
    ...
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter duration: Snap-back animation duration in milliseconds
    /// - Parameter to: The progress value to animate to
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `endSwipe` signal is emitted
    @discardableResult @inlinable func onEndSwipe(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: SwipeTrackerRef, _ duration: gint64, _ to: Double) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder3<SwipeTrackerRef, gint64, Double, Void>
        let cCallback: @convention(c) (gpointer, gint64, gdouble, gpointer) -> Void = { unownedSelf, arg1, arg2, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call(SwipeTrackerRef(raw: unownedSelf), arg1, Double(arg2))
            return output
        }
        return connect(
            signal: .endSwipe,
    ...
    @discardableResult @inlinable func onUpdateSwipe(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: SwipeTrackerRef, _ progress: Double) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder2<SwipeTrackerRef, Double, Void>
    ...
    // SwipeTracker property signals were not generated due to unavailability of GObject during generation time
}

// MARK: SwipeTracker Class: SwipeTrackerProtocol extension (methods and fields)
public extension SwipeTrackerProtocol {
    /// Return the stored, untyped pointer as a typed pointer to the `HdySwipeTracker` instance.
    @inlinable var swipe_tracker_ptr: UnsafeMutablePointer<HdySwipeTracker>! { return ptr?.assumingMemoryBound(to: HdySwipeTracker.self) }

    /// Whether to allow swiping for more than one snap point at a time. If the
    /// value is `false`, each swipe can only move to the adjacent snap points.
    @inlinable func getAllowLongSwipes() -> Bool {
        let rv = ((hdy_swipe_tracker_get_allow_long_swipes(swipe_tracker_ptr)) != 0)
        return rv
    }

    /// Get whether `self` can be dragged with mouse pointer.
    @inlinable func getAllowMouseDrag() -> Bool {
        let rv = ((hdy_swipe_tracker_get_allow_mouse_drag(swipe_tracker_ptr)) != 0)
        return rv
    }
    ...
    @inlinable func getEnabled() -> Bool {
        let rv = ((hdy_swipe_tracker_get_enabled(swipe_tracker_ptr)) != 0)
        return rv
    }

    /// Get whether `self` is reversing the swipe direction.
    @inlinable func getReversed() -> Bool {
        let rv = ((hdy_swipe_tracker_get_reversed(swipe_tracker_ptr)) != 0)
        return rv
    }

    /// Get `self`'s swipeable widget.
    @inlinable func getSwipeable() -> SwipeableRef! {
        let rv = SwipeableRef(gconstpointer: gconstpointer(hdy_swipe_tracker_get_swipeable(swipe_tracker_ptr)))
        return rv
    }
    ...
    @inlinable func set(allowLongSwipes: Bool) {
        hdy_swipe_tracker_set_allow_long_swipes(swipe_tracker_ptr, gboolean((allowLongSwipes) ? 1 : 0))
    ...
    @inlinable func set(allowMouseDrag: Bool) {
        hdy_swipe_tracker_set_allow_mouse_drag(swipe_tracker_ptr, gboolean((allowMouseDrag) ? 1 : 0))
    ...
    @inlinable func set(enabled: Bool) {
        hdy_swipe_tracker_set_enabled(swipe_tracker_ptr, gboolean((enabled) ? 1 : 0))
    ...
    @inlinable func set(reversed: Bool) {
        hdy_swipe_tracker_set_reversed(swipe_tracker_ptr, gboolean((reversed) ? 1 : 0))
    ...
    @inlinable func shiftPosition(delta: Double) {
        hdy_swipe_tracker_shift_position(swipe_tracker_ptr, gdouble(delta))
    ...
    @inlinable var allowLongSwipes: Bool {
        ...
        /// value is `false`, each swipe can only move to the adjacent snap points.
        nonmutating set {
            hdy_swipe_tracker_set_allow_long_swipes(swipe_tracker_ptr, gboolean((newValue) ? 1 : 0))
        }
    }
    ...
    @inlinable var allowMouseDrag: Bool {
        ...
        /// `false`.
        nonmutating set {
            hdy_swipe_tracker_set_allow_mouse_drag(swipe_tracker_ptr, gboolean((newValue) ? 1 : 0))
        }
    }
    ...
    @inlinable var enabled: Bool {
        ...
        /// processed. Usually widgets will want to expose this via a property.
        nonmutating set {
            hdy_swipe_tracker_set_enabled(swipe_tracker_ptr, gboolean((newValue) ? 1 : 0))
        }
    }
    ...
    @inlinable var reversed: Bool {
        ...
        /// can be used for supporting RTL text direction.
        nonmutating set {
            hdy_swipe_tracker_set_reversed(swipe_tracker_ptr, gboolean((newValue) ? 1 : 0))
        }
    }
...
///
/// The `TabBarProtocol` protocol exposes the methods and properties of an underlying `HdyTabBar` instance.
/// The default implementation of these can be found in the protocol extension below.
...
///
public protocol TabBarProtocol: Gtk.BinProtocol, Gtk.BuildableProtocol {
        /// Untyped pointer to the underlying `HdyTabBar` instance.
    var ptr: UnsafeMutableRawPointer! { get }

    /// Typed pointer to the underlying `HdyTabBar` instance.
    var tab_bar_ptr: UnsafeMutablePointer<HdyTabBar>! { get }
...
///
/// The `TabBarRef` type acts as a lightweight Swift reference to an underlying `HdyTabBar` instance.
/// It exposes methods that can operate on this data type through `TabBarProtocol` conformance.
/// Use `TabBarRef` only as an `unowned` reference to an existing `HdyTabBar` instance.
///
...
public extension TabBarRef {
    /// Designated initialiser from the underlying `C` data type
    @inlinable init(_ p: UnsafeMutablePointer<HdyTabBar>) {
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Designated initialiser from a constant pointer to the underlying `C` data type
    @inlinable init(_ p: UnsafePointer<HdyTabBar>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: p))
    }

    /// Conditional initialiser from an optional pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafeMutablePointer<HdyTabBar>?) {
        guard let p = maybePointer else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Conditional initialiser from an optional, non-mutable pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafePointer<HdyTabBar>?) {
        guard let p = UnsafeMutablePointer(mutating: maybePointer) else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }
...
///
/// The `TabBar` type acts as a reference-counted owner of an underlying `HdyTabBar` instance.
/// It provides the methods that can operate on this data type through `TabBarProtocol` conformance.
/// Use `TabBar` as a strong reference or owner of a `HdyTabBar` instance.
///
open class TabBar: Gtk.Bin, TabBarProtocol {
        /// Designated initialiser from the underlying `C` data type.
    /// This creates an instance without performing an unbalanced retain
    /// i.e., ownership is transferred to the `TabBar` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafeMutablePointer<HdyTabBar>) {
        super.init(cPointer: op)
    }
    ...
    /// i.e., ownership is transferred to the `TabBar` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<HdyTabBar>) {
        super.init(raw: UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: op)))
    }
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// Will retain `HdyTabBar`.
    /// i.e., ownership is transferred to the `TabBar` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<HdyTabBar>) {
        super.init(retainingCPointer: op)
    }
...
public enum TabBarPropertyName: String, PropertyNameProtocol {
    ...
    case extraDragDestTargets = "extra-drag-dest-targets"
    /// Whether the widget should grab focus when it is clicked with the mouse.
    /// 
    /// This property is only relevant for widgets that can take focus.
    /// 
...
public enum TabBarSignalName: String, SignalNameProtocol {
    ...
    case extraDragDataReceived = "extra-drag-data-received"
    case focus = "focus"
    /// The signal "focus-event" is emitted when an object gained or lost
    /// focus.
    ///
    ...
    /// After content is dropped, the `HdyTabBar::extra-drag-data-received` signal
    /// can be used to retrieve and process the drag data.
    case notifyExtraDragDestTargets = "notify::extra-drag-dest-targets"
    /// Whether the widget should grab focus when it is clicked with the mouse.
    /// 
    /// This property is only relevant for widgets that can take focus.
    /// 
...
public extension TabBarProtocol {
    ...
    /// 
    /// See `GtkWidget::drag-data-received`.
    /// - Note: This represents the underlying `extra-drag-data-received` signal
    /// - Parameter flags: Flags
    /// - Parameter unownedSelf: Reference to instance of self
    /// - Parameter page: the `HdyTabPage` matching the tab the content was dropped onto
    ...
    /// - Parameter handler: The signal handler to call
    /// Run the given callback whenever the `extraDragDataReceived` signal is emitted
    @discardableResult @inlinable func onExtraDragDataReceived(flags: ConnectFlags = ConnectFlags(0), handler: @escaping ( _ unownedSelf: TabBarRef, _ page: TabPageRef, _ context: Gdk.DragContextRef, _ data: Gtk.SelectionDataRef, _ info: UInt, _ time: UInt) -> Void ) -> Int {
        typealias SwiftHandler = GLib.ClosureHolder6<TabBarRef, TabPageRef, Gdk.DragContextRef, Gtk.SelectionDataRef, UInt, UInt, Void>
        let cCallback: @convention(c) (gpointer, gpointer, gpointer, gpointer, guint, guint, gpointer) -> Void = { unownedSelf, arg1, arg2, arg3, arg4, arg5, userData in
            let holder = Unmanaged<SwiftHandler>.fromOpaque(userData).takeUnretainedValue()
            let output: Void = holder.call(TabBarRef(raw: unownedSelf), TabPageRef(raw: arg1), Gdk.DragContextRef(raw: arg2), Gtk.SelectionDataRef(raw: arg3), UInt(arg4), UInt(arg5))
            return output
        }
        return connect(
            signal: .extraDragDataReceived,
            flags: flags,
            data: Unmanaged.passRetained(SwiftHandler(handler)).toOpaque(),
            destroyData: { userData, _ in UnsafeRawPointer(userData).flatMap(Unmanaged<SwiftHandler>.fromOpaque(_:))?.release() },
            signalHandler: unsafeBitCast(cCallback, to: GCallback.self)
    ...
    /// Typed `extra-drag-data-received` signal for using the `connect(signal:)` methods
    static var extraDragDataReceivedSignal: TabBarSignalName { .extraDragDataReceived }
    
    // TabBar property signals were not generated due to unavailability of GObject during generation time
}

// MARK: TabBar Class: TabBarProtocol extension (methods and fields)
public extension TabBarProtocol {
    /// Return the stored, untyped pointer as a typed pointer to the `HdyTabBar` instance.
    @inlinable var tab_bar_ptr: UnsafeMutablePointer<HdyTabBar>! { return ptr?.assumingMemoryBound(to: HdyTabBar.self) }

    /// Gets whether the tabs automatically hide, see `hdy_tab_bar_set_autohide()`.
    @inlinable func getAutohide() -> Bool {
        let rv = ((hdy_tab_bar_get_autohide(tab_bar_ptr)) != 0)
        return rv
    }

    /// Gets the widget shown after the tabs.
    @inlinable func getEndActionWidget() -> Gtk.WidgetRef! {
        let rv = Gtk.WidgetRef(hdy_tab_bar_get_end_action_widget(tab_bar_ptr))
        return rv
    }

    /// Gets whether tabs should expand, see `hdy_tab_bar_set_expand_tabs()`.
    @inlinable func getExpandTabs() -> Bool {
        let rv = ((hdy_tab_bar_get_expand_tabs(tab_bar_ptr)) != 0)
        return rv
    }

    /// Gets extra drag destination targets, see
    /// `hdy_tab_bar_set_extra_drag_dest_targets()`.
    @inlinable func getExtraDragDestTargets() -> Gtk.TargetListRef! {
        let rv = Gtk.TargetListRef(hdy_tab_bar_get_extra_drag_dest_targets(tab_bar_ptr))
        return rv
    }

    /// Gets whether tabs use inverted layout, see `hdy_tab_bar_set_inverted()`.
    @inlinable func getInverted() -> Bool {
        let rv = ((hdy_tab_bar_get_inverted(tab_bar_ptr)) != 0)
        return rv
    }

    /// Gets whether `self` is overflowing.
    @inlinable func getIsOverflowing() -> Bool {
        let rv = ((hdy_tab_bar_get_is_overflowing(tab_bar_ptr)) != 0)
        return rv
    }

    /// Gets the widget shown before the tabs.
    @inlinable func getStartActionWidget() -> Gtk.WidgetRef! {
        let rv = Gtk.WidgetRef(hdy_tab_bar_get_start_action_widget(tab_bar_ptr))
        return rv
    }

    /// Gets the value of the `HdyTabBar:tabs-revealed` property.
    @inlinable func getTabsRevealed() -> Bool {
        let rv = ((hdy_tab_bar_get_tabs_revealed(tab_bar_ptr)) != 0)
        return rv
    }

    /// Gets the `HdyTabView` `self` controls.
    @inlinable func getView() -> TabViewRef! {
        let rv = TabViewRef(gconstpointer: gconstpointer(hdy_tab_bar_get_view(tab_bar_ptr)))
        return rv
    }
    ...
    @inlinable func set(autohide: Bool) {
        hdy_tab_bar_set_autohide(tab_bar_ptr, gboolean((autohide) ? 1 : 0))
    
    }

    /// Sets the widget to show after the tabs.
    @inlinable func setEndAction(widget: Gtk.WidgetRef? = nil) {
        hdy_tab_bar_set_end_action_widget(tab_bar_ptr, widget?.widget_ptr)
    
    }
    /// Sets the widget to show after the tabs.
    @inlinable func setEndAction<WidgetT: Gtk.WidgetProtocol>(widget: WidgetT?) {
        hdy_tab_bar_set_end_action_widget(tab_bar_ptr, widget?.widget_ptr)
    ...
    @inlinable func set(expandTabs: Bool) {
        hdy_tab_bar_set_expand_tabs(tab_bar_ptr, gboolean((expandTabs) ? 1 : 0))
    ...
    @inlinable func set(extraDragDestTargets: Gtk.TargetListRef? = nil) {
        hdy_tab_bar_set_extra_drag_dest_targets(tab_bar_ptr, extraDragDestTargets?.target_list_ptr)
    ...
    /// After content is dropped, the `HdyTabBar::extra-drag-data-received` signal can
    /// be used to retrieve and process the drag data.
    @inlinable func set<TargetListT: Gtk.TargetListProtocol>(extraDragDestTargets: TargetListT?) {
        hdy_tab_bar_set_extra_drag_dest_targets(tab_bar_ptr, extraDragDestTargets?.target_list_ptr)
    ...
    @inlinable func set(inverted: Bool) {
        hdy_tab_bar_set_inverted(tab_bar_ptr, gboolean((inverted) ? 1 : 0))
    
    }

    /// Sets the widget to show before the tabs.
    @inlinable func setStartAction(widget: Gtk.WidgetRef? = nil) {
        hdy_tab_bar_set_start_action_widget(tab_bar_ptr, widget?.widget_ptr)
    
    }
    /// Sets the widget to show before the tabs.
    @inlinable func setStartAction<WidgetT: Gtk.WidgetProtocol>(widget: WidgetT?) {
        hdy_tab_bar_set_start_action_widget(tab_bar_ptr, widget?.widget_ptr)
    ...
    @inlinable func set(view: TabViewRef? = nil) {
        hdy_tab_bar_set_view(tab_bar_ptr, view?.tab_view_ptr)
    ...
    @inlinable var autohide: Bool {
        ...
        /// See `HdyTabBar:tabs-revealed`.
        nonmutating set {
            hdy_tab_bar_set_autohide(tab_bar_ptr, gboolean((newValue) ? 1 : 0))
        }
    }
    ...
    @inlinable var endActionWidget: Gtk.WidgetRef! {
        ...
        /// Sets the widget to show after the tabs.
        nonmutating set {
            hdy_tab_bar_set_end_action_widget(tab_bar_ptr, UnsafeMutablePointer<GtkWidget>(newValue?.widget_ptr))
        }
    }
    ...
    @inlinable var expandTabs: Bool {
        ...
        /// Expand is enabled by default.
        nonmutating set {
            hdy_tab_bar_set_expand_tabs(tab_bar_ptr, gboolean((newValue) ? 1 : 0))
        }
    }

    /// Gets extra drag destination targets, see
    /// `hdy_tab_bar_set_extra_drag_dest_targets()`.
    @inlinable var extraDragDestTargets: Gtk.TargetListRef! {
        /// Gets extra drag destination targets, see
        /// `hdy_tab_bar_set_extra_drag_dest_targets()`.
        get {
            let rv = Gtk.TargetListRef(hdy_tab_bar_get_extra_drag_dest_targets(tab_bar_ptr))
        ...
        /// be used to retrieve and process the drag data.
        nonmutating set {
            hdy_tab_bar_set_extra_drag_dest_targets(tab_bar_ptr, UnsafeMutablePointer<GtkTargetList>(newValue?.target_list_ptr))
        }
    }
    ...
    @inlinable var inverted: Bool {
        ...
        /// beginning and the indicator at the end rather than the opposite.
        nonmutating set {
            hdy_tab_bar_set_inverted(tab_bar_ptr, gboolean((newValue) ? 1 : 0))
        }
    }
    ...
    @inlinable var startActionWidget: Gtk.WidgetRef! {
        ...
        /// Sets the widget to show before the tabs.
        nonmutating set {
            hdy_tab_bar_set_start_action_widget(tab_bar_ptr, UnsafeMutablePointer<GtkWidget>(newValue?.widget_ptr))
        }
    }
    ...
    @inlinable var view: TabViewRef! {
        ...
        /// Sets the `HdyTabView` `self` controls.
        nonmutating set {
            hdy_tab_bar_set_view(tab_bar_ptr, UnsafeMutablePointer<HdyTabView>(newValue?.tab_view_ptr))
        }
    }
