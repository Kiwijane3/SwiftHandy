...
///
/// The `WindowHandleProtocol` protocol exposes the methods and properties of an underlying `HdyWindowHandle` instance.
...
///
public protocol WindowHandleProtocol: Gtk.EventBoxProtocol, Gtk.BuildableProtocol {
        /// Untyped pointer to the underlying `HdyWindowHandle` instance.
    var ptr: UnsafeMutableRawPointer! { get }

    /// Typed pointer to the underlying `HdyWindowHandle` instance.
    var window_handle_ptr: UnsafeMutablePointer<HdyWindowHandle>! { get }
...
///
/// The `WindowHandleRef` type acts as a lightweight Swift reference to an underlying `HdyWindowHandle` instance.
/// It exposes methods that can operate on this data type through `WindowHandleProtocol` conformance.
/// Use `WindowHandleRef` only as an `unowned` reference to an existing `HdyWindowHandle` instance.
///
...
public extension WindowHandleRef {
    ...
    @inlinable init(_ p: UnsafeMutablePointer<HdyWindowHandle>) {
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Designated initialiser from a constant pointer to the underlying `C` data type
    @inlinable init(_ p: UnsafePointer<HdyWindowHandle>) {
        ptr = UnsafeMutableRawPointer(UnsafeMutablePointer(mutating: p))
    }

    /// Conditional initialiser from an optional pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafeMutablePointer<HdyWindowHandle>?) {
        guard let p = maybePointer else { return nil }
        ptr = UnsafeMutableRawPointer(p)
    }

    /// Conditional initialiser from an optional, non-mutable pointer to the underlying `C` data type
    @inlinable init!(_ maybePointer: UnsafePointer<HdyWindowHandle>?) {
...
///
/// The `WindowHandle` type acts as a reference-counted owner of an underlying `HdyWindowHandle` instance.
...
open class WindowHandle: Gtk.EventBox, WindowHandleProtocol {
    ...
    @inlinable public init(_ op: UnsafeMutablePointer<HdyWindowHandle>) {
    ...
    /// i.e., ownership is transferred to the `WindowHandle` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(_ op: UnsafePointer<HdyWindowHandle>) {
    ...
    /// Designated initialiser from the underlying `C` data type.
    /// Will retain `HdyWindowHandle`.
    /// i.e., ownership is transferred to the `WindowHandle` instance.
    /// - Parameter op: pointer to the underlying object
    @inlinable public init(retaining op: UnsafeMutablePointer<HdyWindowHandle>) {
...
public extension WindowHandleProtocol {
    /// Return the stored, untyped pointer as a typed pointer to the `HdyWindowHandle` instance.
    @inlinable var window_handle_ptr: UnsafeMutablePointer<HdyWindowHandle>! { return ptr?.assumingMemoryBound(to: HdyWindowHandle.self) }
