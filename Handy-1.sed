...
s/: \([A-Za-z][A-Za-z.]*Handler[,)]\)/: @escaping \1/g
...
s/: \([A-Za-z][A-Za-z.]*Listener[,)]\)/: @escaping \1/g
s/: \([A-Za-z][A-Za-z.]*ListenerInit[,)]\)/: @escaping \1/g
...
s|@inlinable public init<T: ApplicationWindowProtocol>(applicationWindow other: T)|@inlinable public init<T: ApplicationWindowProtocol>(handyApplicationWindow other: T)|
s|@inlinable public init<T: WindowProtocol>(window other: T)|@inlinable public init<T: WindowProtocol>(handyWindow other: T)|
